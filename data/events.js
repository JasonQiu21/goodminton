...
export const createEvent = async (eventName, eventDate, eventType, tournamentType = null) => {
	...
	if (eventType.toLowerCase().includes("tournament")) {
		...
		if (tournamentType.toLowerCase() !== "single elim" && tournamentType.toLowerCase() !== "double elim" && tournamentType.toLowerCase() !== "round robin" && tournamentType.toLowerCase() !== "swiss")
